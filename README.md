...
Using the PuLP library, an integer programming model is designed and solved to obtain a matching. This model aims to maximize the match quality based on interests, ensuring each mentee is paired with a suitable mentor while adhering to capacity constraints.
